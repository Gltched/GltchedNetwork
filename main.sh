...
if [ "$updcheck" = "true" ]; then
  ...
  if [ -d "old/java/lobby" -a -d "old/java/bungee_command" ]; then
...
java -Xmx16M -Xms16M -jar bungee-dist.jar > /dev/null 2>&1 &
cd -
...
echo starting lobby...
cd java/lobby
java -Xmx256M -Xms256M -jar craftbukkit-1.5.2-R1.0.jar
